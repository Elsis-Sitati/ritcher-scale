...
#-*- coding: utf-8 -*-
"""
Usage: ritcher <numbers>...
Examples:
  ritcher 1 25 221 57 32 68 8
Options:
...
from ritcher import __version__
...
def normalize_numbers(numbers):
    ...
    ritcher = u' '.join(steps[int(round((n - min(numbers)) / step))] for n in numbers)
    cprint(ritcher, 'green')
